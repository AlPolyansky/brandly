...
gulp.task('scripts', function(){
	return gulp.src([
		...
		'src/libs/flickity/dist/flickity.pkgd.min.js',
		'src/libs/jQuery.mmenu/dist/js/jquery.mmenu.all.min.js'	//тут пишем пути к js файлам библиотек
	])
...
gulp.task('css-libs', ['sass'], function(){
	return gulp.src([
		'src/libs/bootsrtap-grid/bootstrap.min.css',
		'src/libs/flickity/dist/flickity.min.css',
		'src/libs/jQuery.mmenu/dist/css/jquery.mmenu.all.css',
		'src/libs/font-awesome/css/font-awesome.css' //тут пишем пути к css файлам библиотек
	])
